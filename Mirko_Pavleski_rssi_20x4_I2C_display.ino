...
#define AUDIO_MUTE_CIRCUIT A1 //enables the mute funcion on arduino during power up the radio By Emerson Capuano (emercito)
 ...
 */
Band band[] = {
  {"VHF", FM_BAND_TYPE, 6400, 10800,  10030, 10},
...
LiquidCrystal_I2C lcd(0x27, 16, 2); //added to work with I2C 16x2 LCD devices by Emerson Capuano
SI4735 rx;
...
void setup()
{
  ...
  rx.setAudioMuteMcuPin(AUDIO_MUTE_CIRCUIT); //added to enable mute on Arduino pin by Emerson capuano ( emercito)
...
/* *******************************
   Shows RSSI status
*/
void showRSSI() //modified to show the rssi signal on position 0, 3 on 20x4 display by Emerson Capuano ( emercito)
{
